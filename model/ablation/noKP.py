...
if __name__ == "__main__":
    ...
    for i in range(repeat_train):
        imu_encoder, _ = get_unimodal_models(
            train_set,
            val_set,
            test_set,
            device=device,
        ...
        #     torch.load(checkpoint_path / "PRISM 2026-02-01 23:16:29-latest.pt"), strict=False
        # )
        # pca2D(model, test_loader, device, pic_tag="No KP")
