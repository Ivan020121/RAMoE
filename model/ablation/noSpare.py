...
class PRISM(nn.Module):
    ...
    def forward(self, imu_input: torch.Tensor, kp_input: torch.Tensor):
        ...
        s = self.classifier(modal_out) # (B, 2*fusion_dim) -> # (B, 10)
        return s
...
if __name__ == "__main__":
    ...
    for i in range(repeat_train):
        ...
        #     torch.load(checkpoint_path / "PRISM 2026-02-01 23:05:59-latest.pt"), strict=False
        # )
        # pca2D(model, test_loader, device, pic_tag="No Spare")
